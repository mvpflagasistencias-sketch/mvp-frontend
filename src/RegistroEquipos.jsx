  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in duration-500 text-left">
      <div className="flex justify-between items-center">
        ...
        <button
          onClick={onBack}
          className="bg-gray-800 hover:bg-gray-700 text-white px-6 py-2 rounded-xl transition-all font-bold text-xs uppercase"
        >
          ← Volver al Dashboard
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-[#1e293b] rounded-3xl border border-gray-700 shadow-2xl overflow-hidden flex flex-col">
          <div className="bg-[#0f172a] p-4 border-b border-gray-700 flex flex-col gap-3">
            <h3 className="text-lg font-bold text-blue-400 uppercase tracking-tighter italic">
              Equipos en la Liga
            </h3>
              ...
              <tbody className="text-gray-300">
                {equiposFiltrados.length > 0 ? (
                  equiposFiltrados.map((eq) => (
                    ...
                    >
                      <td className="p-4 font-medium italic text-gray-500 text-sm">
                        ID #{eq.id}
                      </td>
